    ...
    <div class="headerContainer">
        ...
        <div class="header-icon-group">
            <?php if (isset($_SESSION['members'])): ?>
                <div class="dropdown">
                    <a style="color:#043f98" class="btnss dropdown-toggle" href="#" id="dropdownMenuLink" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            ...
            <?php endif; ?>
            <a href=""><img class="header-img icon icon-cart" src="svg/svg-cart.svg" alt=""><span class="badge badge-pill badge-primary cart-count">0</span></a>
            ...
            <div id="sidebarMenu">
                <ul class="sidebarMenuInner">
                    ...
                    <li class="sidebarMenuInner-li">
                        <a class="sidebarMenuInner-a" href="#" target="_blank">
                    ...
                    <li class="sidebarMenuInner-li">
                        <a class="sidebarMenuInner-a" href="#" target="_blank">
                            <img class="sidebarMenu-icon" src="svg/svg-map.svg" alt="">地圖探索
                        </a>
                    </li>
